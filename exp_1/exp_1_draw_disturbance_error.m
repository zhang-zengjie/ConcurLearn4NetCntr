...
plot(time(1:2:end), d(1:7:end, 1:2:end) - hat_beta_conv(1:7:end,1:2:end),'LineWidth',1.5,'LineStyle','-.');
...
hold on;
set(0, 'DefaultFigureRenderer', 'painters')
plot(time(1:2:end), d(1:7:end, 1:2:end) - hat_beta(1:7:end,1:2:end),'LineWidth',1.5,'LineStyle','-.');
axis([0,time(end),-0.60001,0.60001]);
line([0,time(end)],[0,0],'LineWidth',1.2,'LineStyle','-.','color','k');
ax = gca;
ax.XTick = 0:1:5;
